...
public class ChocChipTest {
    @Test 
    public void testConstructor() {
        try {
            Cookie yum = new GingerbreadCookie();
            yum = new ChocChip(yum);
            assertNotNull(yum);
        }
        catch (Exception e) {
    ...
    public void testDescription() {
        ...
        String expectedResult = "Gingerbread, Chocolate Chip";
	...
	// 1b. Declare actual and expected outputs
	String expectedResult = "[[Gingerbread,101,$ 0.5],Chocolate Chip,200,$ 0.75]";
	String testOutput = null;
